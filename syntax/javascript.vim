...
syntax match   jsObjectMethodAsync contained /async\%( \k\+\)\@=/ skipwhite skipempty nextgroup=jsObjectMethodType
...
syntax region  jsClassBlock         contained matchgroup=jsClassBraces         start=/{/  end=/}/  contains=jsClassFuncName,jsClassMethodType,jsClassMethodStatic,jsClassMethodAsync,jsArrowFunction,jsArrowFuncArgs,jsComment,jsGenerator,jsDecorator,jsClassProperty,jsClassPropertyComputed,jsClassStringKey,jsNoise extend fold
...
syntax region  jsBlock              contained matchgroup=jsBraces              start=/{/  end=/}/  contains=@jsAll,jsSpreadExpression extend fold
...
syntax region  jsObject                       matchgroup=jsObjectBraces        start=/{/  end=/}/  contains=jsObjectKey,jsObjectKeyString,jsObjectKeyComputed,jsObjectSeparator,jsObjectFuncName,jsObjectMethodType,jsObjectMethodAsync,jsGenerator,jsComment,jsObjectStringKey,jsSpreadExpression,jsDecorator extend fold
...
syntax match   jsClassMethodType        contained /\%(get\|set\)\%( \k\+\)\@=/ skipwhite skipempty nextgroup=jsFuncName,jsClassProperty
syntax match   jsClassMethodStatic      contained /static\%( \k\+\)\@=/ skipwhite skipempty nextgroup=jsClassMethodType,jsClassMethodAsync
syntax match   jsClassMethodAsync       contained /async\%( \k\+\)\@=/ skipwhite skipempty nextgroup=jsClassMethodType
...
if version >= 508 || !exists("did_javascript_syn_inits")
  ...
  HiLink jsClassMethodStatic    Type
  HiLink jsClassMethodAsync     Keyword
  HiLink jsObjectMethodType     Type
  HiLink jsObjectMethodAsync    Keyword
